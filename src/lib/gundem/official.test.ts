...
import { getOfficialAccountEmails, isOfficialUser } from './official';
...
describe('isOfficialUser', () => {
  ...
  it('legacy seed hesabı ve OFFICIAL_BOT gönderisi resmi kalır', () => {
    expect(isOfficialUser({ email: 'official@ofsaytyok.invalid' })).toBe(true);
